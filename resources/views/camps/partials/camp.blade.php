<div class="card__camp p-1 border flex flex-col gap-1 justify-between rounded">
    ...
    <a href="{{ route('camps.show', $camp->slug) }}" class="btn btn--medium border w-full text-center rounded hover:bg-black hover:text-white transition-all">View Campground</a>
</div>