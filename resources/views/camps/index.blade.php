...
@section('content')
    <div class=" bg-stone-100 rounded p-10 mb-3 flex flex-col gap-2 sm:flex-row justify-between">
        <div class=" w-full sm:w-2/4 md:w-2/5 flex flex-col gap-6">
            ...
            {{-- Search form --}}
            <form action="{{ route('camps.index') }}" method="GET" class=" flex flex-col sm:flex-row gap-1">
                ...
                <button type="submit" class=" w-full btn btn--medium border text-center bg-black text-white sm:w-fit">Search</button>
            </form>
