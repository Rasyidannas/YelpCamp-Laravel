                ...
                <div class="flex flex-col gap-2 pt-20">
                    <div class=" w-full sm:w-4/5 flex flex-col gap-2">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-2">
                            ...
                            <div class="flex flex-col gap-1/2">
                                ...
                                <div x-data="{
                                    ...
                                    <input class="@error('password') border-red-500 @else border-slate-100 @enderror
                                        ...
                                        id="password" placeholder="Enter your password" x-cloak x-bind:type="passShow ? 'text' : 'password' " name="password"/>
                            ...
                            <div class="">
                                <input class=" w-1 h-1" id="remember" type="checkbox" name="remember" value="{{ old('remember') ? 'checked' : '' }}">
                                <label for="remember" class="text-neutral-500">Remember me</label>
                            </div>
                            <button type="submit" class="btn btn--medium bg-black text-white">Login</button>
                        </form>
                        
                        <p class=" text-small">Not a user yet? <span><a href="{{ route('register') }}" class="btn underline text-blue-400">Create an account</a></span></p>
                    </div>
                </div>
            </div>
